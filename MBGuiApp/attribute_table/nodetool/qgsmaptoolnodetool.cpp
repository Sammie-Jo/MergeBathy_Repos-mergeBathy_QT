...
void QgsMapToolNodeTool::canvasPressEvent( QgsMapMouseEvent* e )
{
  ...
  if ( !mSelectedFeature )
  {
    ...
    connect( MBGuiApp::instance()->layerTreeView(), SIGNAL( currentLayerChanged( QgsMapLayer* ) ), this, SLOT( currentLayerChanged( QgsMapLayer* ) ) );
    ...
    MBGuiApp::instance()->addDockWidget( Qt::LeftDockWidgetArea, mNodeEditor );
...
void QgsMapToolNodeTool::cleanTool( bool deleteSelectedFeature )
{
  ...
  if ( mSelectedFeature )
  {
    ...
    disconnect( MBGuiApp::instance()->layerTreeView(), SIGNAL( currentLayerChanged( QgsMapLayer* ) ), this, SLOT( currentLayerChanged( QgsMapLayer* ) ) );
