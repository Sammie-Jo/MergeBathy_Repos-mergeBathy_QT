...
QgsIdentifyResultsWebView::QgsIdentifyResultsWebView( QWidget *parent ) : QWebView( parent ) // QgsWebView( parent )
{
    ...
    , mDock( nullptr )
{
  ...
  mDock = new QDockWidget( tr( "Identify Results" ), MBGuiApp::instance() );
  mDock->setObjectName( "IdentifyResultsDock" );
  mDock->setAllowedAreas( Qt::LeftDockWidgetArea | Qt::RightDockWidgetArea );
  mDock->setWidget( this );
  if ( !MBGuiApp::instance()->restoreDockWidget( mDock ) )
    MBGuiApp::instance()->addDockWidget( Qt::RightDockWidgetArea, mDock );
  else
    MBGuiApp::instance()->panelMenu()->addAction( mDock->toggleViewAction() );
...
{
  connect( this, SIGNAL( activateLayer( QgsMapLayer * ) ), MBGuiApp::instance(), SLOT( setActiveLayer( QgsMapLayer * ) ) );
  emit activateLayer( layer( lstResults->currentItem() ) );
  disconnect( this, SIGNAL( activateLayer( QgsMapLayer * ) ), MBGuiApp::instance(), SLOT( setActiveLayer( QgsMapLayer * ) ) );
}
...
void QgsIdentifyResultsDialog::layerProperties( QTreeWidgetItem *item )
{
  ...
  MBGuiApp::instance()->showLayerProperties( vlayer );
}
