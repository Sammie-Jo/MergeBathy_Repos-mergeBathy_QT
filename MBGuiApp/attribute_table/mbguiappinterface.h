/***************************************************************************
                          MBGuiAppInterface.h
 Interface class for exposing functions in MbguiApp for use by plugins
                             -------------------
  begin                : 2004-02-11
 ...
 * \brief Interface class to provide access to private methods in MbguiApp
 * for use by plugins.
 *
...
class APP_EXPORT MBGuiAppInterface : public QgisInterface
{
    Q_OBJECT
  ...
  public:
    /**
     * Constructor.
     * @param qgis Pointer to the MbguiApp object
     */
    MBGuiAppInterface( MbguiApp *qgisapp );
    ~MBGuiAppInterface();
...
//    QgsPluginManagerInterface* pluginManagerInterface() override;
    ...
    /** Gives access to main MbguiApp object

        Plugins don't need to know about MbguiApp, as we pass it as QWidget,
    ...
    /** Get reference font for initial qApp (may not be same as MbguiApp) */
...
//    QgsAdvancedDigitizingDockWidget *cadDockWidget() override;
  ...
  private:
    ...
    MBGuiAppInterface( MBGuiAppInterface const & );

    /// QgisInterface aren't copied
    MBGuiAppInterface & operator=( MBGuiAppInterface const & );

    //! Pointer to the MbguiApp object
    MbguiApp *qgis;
...
#endif //#define MBGuiAppInterface_H
