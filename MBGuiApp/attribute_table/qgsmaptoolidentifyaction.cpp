...
{
  resultsDialog()->clear();
  connect( this, SIGNAL( identifyProgress( int, int ) ), MBGuiApp::instance(), SLOT( showProgress( int, int ) ) );
  connect( this, SIGNAL( identifyMessage( QString ) ), MBGuiApp::instance(), SLOT( showStatusMessage( QString ) ) );
  ...
  disconnect( this, SIGNAL( identifyProgress( int, int ) ), MBGuiApp::instance(), SLOT( showProgress( int, int ) ) );
  disconnect( this, SIGNAL( identifyMessage( QString ) ), MBGuiApp::instance(), SLOT( showStatusMessage( QString ) ) );

  if ( results.isEmpty() )
  {
    resultsDialog()->clear();
    MBGuiApp::instance()->statusBar()->showMessage( tr( "No features at this position found." ) );
  }
  else
  {
