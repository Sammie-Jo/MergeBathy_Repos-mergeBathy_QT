    ...
    : mMenu( new QMenu )
{
  ...
  mMenu->addAction( MBGuiApp::instance()->actionShowAllLayers() );
  mMenu->addAction( MBGuiApp::instance()->actionHideAllLayers() );
  mMenu->addAction( MBGuiApp::instance()->actionShowSelectedLayers() );
  mMenu->addAction( MBGuiApp::instance()->actionHideSelectedLayers() );
  mMenu->addSeparator();
...
{
  QgsLayerTreeModel* model = MBGuiApp::instance()->layerTreeView()->layerTreeModel();
...
QStringList QgsVisibilityPresets::orderedPresetVisibleLayers( const QString& name ) const
{
  ...
  QgsLayerTreeMapCanvasBridge* bridge = MBGuiApp::instance()->layerTreeCanvasBridge();
