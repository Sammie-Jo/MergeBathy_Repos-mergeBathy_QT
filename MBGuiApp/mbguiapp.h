...
//    void populateFields();
        ...
        #ifdef Qt5
            MBGuiApp(QWidget* parent = 0, Qt::WindowFlags fl = 0 );
        #else
            MBGuiApp(QWidget* parent = 0, Qt::WFlags fl = 0 );
        #endif
        ~MBGuiApp();

        QtDoublePropertyManager *getDoubleManager() { return doubleManager; }
        QtStringPropertyManager *getStringManager() { return stringManager; }
        QtPointFPropertyManager *getPointFManager() { return pointFManager; }
        QtSizeFPropertyManager *getSizeFManager() { return sizeFManager; }
        QtBoolPropertyManager *getBoolManager() { return boolManager; }
        QtIntPropertyManager *getIntManager() { return intManager; }
        QtEnumPropertyManager *getEnumManager() { return enumManager; }
        QtVariantPropertyManager *getVariantManager() { return variantManager; }
...
//        void tab1Changed();
//        void tab2Changed();
        void canvasDoubleClicked_depths(QMouseEvent *event);
        void canvasDoubleClicked_error(QMouseEvent *event);
        void canvasDoubleClicked_nei(QMouseEvent *event);
        void canvasDoubleClicked_rei(QMouseEvent *event);
        void canvasDoubleClicked_mean(QMouseEvent *event);
        ...
        void updateNewLayerInsertionPoint_yz();
        //! connected to layer tree registry bridge, selects first of the newly added map layers
        void autoSelectAddedLayer( QList<QgsMapLayer*> layers );
        void autoSelectAddedLayer_yz( QList<QgsMapLayer*> layers );
        void activeLayerChanged( QgsMapLayer *layer );
        void activeLayerChanged_yz( QgsMapLayer *layer );
        //! Zoom to full extent
        void zoomFull();
...
#pragma endregion
    ...
    private slots:
       ...
       void refreshMapTools_xy();
       void refreshMapTools_yz();
       void refreshMapTools_depths();
       void refreshMapTools_error();
       void refreshMapTools_nei();
       void refreshMapTools_rei();
       void refreshMapTools_mean();
       void refreshMapTools();
       void showMBLog();
       void logMB();
       ...
       void runMB();
//        void toggleExcludes();
       void toggleExcludes(bool isCanvasXY);
        void toggleExcludes2(QgsMapLayer *layer, QWidget* parent);
        void deleteItem();
        void addLayer();
        void addGroup();
        ...
        void setMBPath(bool isGlobal);
        void setLocalMBPath();
        void setGlobalMBPath();
        void open();
        void closeProject();
        bool save();
        void saveAs();
...
//        void showComposerManager();
        ...
        QgsMapLayer *activeLayer_xy();
        QgsMapLayer *activeLayer_yz();
        //! set the active layer
        bool setActiveLayer_xy( QgsMapLayer * );
        bool setActiveLayer_yz( QgsMapLayer * );
...
//        void layerEditStateChanged_xy();
//        void layerEditStateChanged_yz();
...
//        void selectionChanged( QgsMapLayer *layer );
        void selectionChanged_xy( QgsMapLayer *layer );
        void selectionChanged_yz( QgsMapLayer *layer );

        void showProgress( int theProgress, int theTotalSteps );
        void extentChanged();
        void extentChanged_xy();
        void extentChanged_yz();
        void showRotation();
...
private:
        QgsLayerTreeRegistryBridge * layerTreeRegistryBridge_yz;
        QgsLayerTreeRegistryBridge * layerTreeRegistryBridge;
        QProcess *process;
        QPlainTextEdit * logWindow;
        QDockWidget *docklog;
        void writeParamSettings();
        void resetMBParams();
        int validateMBInputs();
        void writeOutputFiles();
        void loadMBResults();
        void createMeanResultLayer();
        void addRasterResultLayer(QString f, QgsMapCanvas* canvas);
        void createActions();
        void createMenus();
        void createUndoView();
//        void readSettings2();
...
//        QAction *tab2ToggleAction;
        ...
        QGroupBox * vGroupBox_canvas_depths;
        QGroupBox * vGroupBox_canvas_error;
        QGroupBox * vGroupBox_canvas_nei;
        QGroupBox * vGroupBox_canvas_rei;
        QGroupBox * vGroupBox_canvas_mean;
        QCheckBox * checkBox_lock_canvas_xy;
        QCheckBox * checkBox_lock_canvas_yz;
        QCheckBox * checkBox_lock_canvas_depths;
        QCheckBox * checkBox_lock_canvas_error;
        QCheckBox * checkBox_lock_canvas_nei;
        QCheckBox * checkBox_lock_canvas_rei;
...
//        QgsMapTool * mpZoomOutTool;
        ...
        QgsMapTool * mpPanTool_xy;
        QgsMapTool * mpZoomInTool_xy;
        QgsMapTool * mpZoomOutTool_xy;

        QgsMapTool * mpPanTool_yz;
        QgsMapTool * mpZoomInTool_yz;
        QgsMapTool * mpZoomOutTool_yz;

        QgsMapTool * mpPanTool_depths;
        QgsMapTool * mpZoomInTool_depths;
        QgsMapTool * mpZoomOutTool_depths;

        QgsMapTool * mpPanTool_error;
        QgsMapTool * mpZoomInTool_error;
        QgsMapTool * mpZoomOutTool_error;

        QgsMapTool * mpPanTool_nei;
        QgsMapTool * mpZoomInTool_nei;
        QgsMapTool * mpZoomOutTool_nei;

        QgsMapTool * mpPanTool_rei;
        QgsMapTool * mpZoomInTool_rei;
        QgsMapTool * mpZoomOutTool_rei;

        QgsMapTool * mpPanTool_mean;
        QgsMapTool * mpZoomInTool_mean;
        QgsMapTool * mpZoomOutTool_mean;


        QgsProviderRegistry *r;
//        QgsLayerTreeView * view;//mLayerTreeView
        MyMenuProvider * myProvider;
        QgsLayerTreeModel * model;
        QgsLayerTreeModel * model_yz;
...
//         MySetDataPathDialog * setDataPathDialog;
        ...
        QtPointFPropertyManager *pointFManager;
        QtSizeFPropertyManager *sizeFManager;
...
//        QtSizePolicyPropertyManager *sizePolicyManager;
        ...
        QtProperty *propertyRunParams_bitstr;
        QtProperty *propertyRunParams_outfname;
        QtProperty *propertyRunParams_ifilelist;
        QtProperty *propertyRunParams_gspacing;
        QtProperty *propertyRunParams_filter;
        QtProperty *propertyRunParams_sscales;
        QtProperty *propertyRunParams_refll;
        QtProperty *propertyRunParams_rotangle;
        QtProperty *propertyRunParams_inmeters;
        QtProperty *propertyRunParams_wrkdir;
        QtProperty *propertyRunParams_mbexe;

        QtProperty *propertyRunParams_prespliner;
        QtProperty *propertyRunParams_presplineroutfname;
        QtProperty *propertyRunParams_presplinerxyze;
        QtProperty *propertyRunParams_presplineruseresults;
        QtProperty *propertyRunParams_presplinerspacing;
        QtProperty *propertyRunParams_presplinertension;
        QtProperty *propertyRunParams_presplinerscale;
        QtProperty *propertyRunParams_presplineralpha;
        QtProperty *propertyRunParams_nthreads;
        QtProperty *propertyRunParams_computeoffsets;
        QtProperty *propertyRunParams_modelflag;
        QtProperty *propertyRunParams_nonegdepths;
        QtProperty *propertyRunParams_kriging;
        QtProperty *propertyRunParams_smoothinmeters;
        QtProperty *propertyRunParams_gridinmeters;
        QtProperty *propertyRunParams_useunscaled;
        QtProperty *propertyRunParams_preinterplocs;
        QtProperty *propertyRunParams_preinterplocsfname;
        QtProperty *propertyRunParams_preinterplocsusage;

        QtProperty *propertyRunParams0prespliner;
        ...
        QAction *mActionLayerSaveAsTemp;
...
//        void createActions2();
        ...
        #ifdef Qt5
            void histogramStretch( bool visibleAreaOnly = false, QgsRasterMinMaxOrigin::Limits theLimits = QgsRasterMinMaxOrigin::Limits::MinMax );
        #else
...
//               , mIdentify( nullptr )
               ...
               , mZoomOut_xy( nullptr )
               , mPan_xy( nullptr )
               , mIdentify_xy( nullptr )
               , mZoomIn_yz( nullptr )
               , mZoomOut_yz( nullptr )
               , mPan_yz( nullptr )
               , mIdentify_yz( nullptr )
               , mZoomIn_depths( nullptr )
               , mZoomOut_depths( nullptr )
               , mPan_depths( nullptr )
               , mZoomIn_error( nullptr )
               , mZoomOut_error( nullptr )
               , mPan_error( nullptr )
               , mZoomIn_nei( nullptr )
               , mZoomOut_nei( nullptr )
               , mPan_nei( nullptr )
               , mZoomIn_rei( nullptr )
               , mZoomOut_rei( nullptr )
               , mPan_rei( nullptr )
               , mZoomIn_mean( nullptr )
               , mZoomOut_mean( nullptr )
               , mPan_mean( nullptr )
...
//               , mSelectRadius( nullptr )
               , mSelect_xy( nullptr )
               , mSelectFeatures_xy( nullptr )
               , mSelectPolygon_xy( nullptr )
               , mSelectFreehand_xy( nullptr )
               , mSelectRadius_xy( nullptr )
               , mSelect_yz( nullptr )
               , mSelectFeatures_yz( nullptr )
               , mSelectPolygon_yz( nullptr )
               , mSelectFreehand_yz( nullptr )
               , mSelectRadius_yz( nullptr )
...
//           QgsMapTool *mIdentify;
           QgsMapTool *mZoomIn_xy;
           QgsMapTool *mZoomOut_xy;
           QgsMapTool *mPan_xy;
           QgsMapTool *mIdentify_xy;
           QgsMapTool *mZoomIn_yz;
           QgsMapTool *mZoomOut_yz;
           QgsMapTool *mPan_yz;
           QgsMapTool *mIdentify_yz;
           QgsMapTool *mZoomIn_depths;
           QgsMapTool *mZoomOut_depths;
           QgsMapTool *mPan_depths;
           QgsMapTool *mZoomIn_error;
           QgsMapTool *mZoomOut_error;
           QgsMapTool *mPan_error;
           QgsMapTool *mZoomIn_nei;
           QgsMapTool *mZoomOut_nei;
           QgsMapTool *mPan_nei;
           QgsMapTool *mZoomIn_rei;
           QgsMapTool *mZoomOut_rei;
           QgsMapTool *mPan_rei;
           QgsMapTool *mZoomIn_mean;
           QgsMapTool *mZoomOut_mean;
           QgsMapTool *mPan_mean;
...
//           QgsMapTool *mSelectRadius;
           ...
           QgsMapTool *mSelect_xy;
           QgsMapTool *mSelectFeatures_xy;
           QgsMapTool *mSelectPolygon_xy;
           QgsMapTool *mSelectFreehand_xy;
           QgsMapTool *mSelectRadius_xy;
           QgsMapTool *mSelect_yz;
           QgsMapTool *mSelectFeatures_yz;
           QgsMapTool *mSelectPolygon_yz;
           QgsMapTool *mSelectFreehand_yz;
           QgsMapTool *mSelectRadius_yz;
    ...
    QgsLayerTreeView *mLayerTreeView_yz;
    //! Helper class that connects layer tree with map canvas
    QgsLayerTreeMapCanvasBridge *mLayerTreeCanvasBridge;
    QgsLayerTreeMapCanvasBridge *mLayerTreeCanvasBridge_yz; //sams
